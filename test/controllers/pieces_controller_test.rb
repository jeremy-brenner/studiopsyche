...
class PiecesControllerTest < ActionController::TestCase
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post :create, piece: { description: @piece.description, gallery_id: @piece.gallery_id, name: @piece.name }
    end
  ...
  test "should update piece" do
    patch :update, id: @piece, piece: { description: @piece.description, gallery_id: @piece.gallery_id, name: @piece.name }
    assert_redirected_to piece_path(assigns(:piece))
  end
